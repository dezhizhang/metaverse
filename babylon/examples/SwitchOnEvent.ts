...
import { MeshBuilder, Engine, HemisphericLight, Scene,ParticleSystem,Vector3,Texture } from "babylonjs";


export default class SwitchOnEvent {
    engine:Engine;
    scene:Scene;
    ...
    createScene():Scene {
        ...
        var particleSystem:any = new ParticleSystem("particles", 5000, this.scene);
