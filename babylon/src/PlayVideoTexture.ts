 ...
 * :last editor: 张德志
 * :date last edited: 2023-08-29 06:07:00
 */
import {  ArcRotateCamera, Color3, Engine, Mesh, MeshBuilder, Scene,StandardMaterial,Vector3, VideoTexture } from "babylonjs";
...
export default class PlayVideoTexture {
    ...
    createScene():Scene {
        ...
        const texture = new VideoTexture('texture','https://playground.babylonjs.com/textures/babylonjs.mp4',scene);
