...
define(['exports', './Transforms-baa7a7e7', './Cartesian2-29c15ffd', './Check-ed9ffed2', './when-f31b6bd1', './EllipsoidTangentPlane-81e77c92', './Math-03750a0b', './Plane-f1000363'], function (exports, Transforms, Cartesian2, Check, when, EllipsoidTangentPlane, _Math, Plane) { 'use strict';
  ...
  OrientedBoundingBox.distanceSquaredTo = function (box, cartesian) {
    ...
    if (numberOfDegenerateAxes === 1) {
      ...
      if (crossVector.equalsEpsilon(validAxis1, _Math.CesiumMath.EPSILON3)) {
