...
define(['./AttributeCompression-69f7b4c3', './Cartesian2-29c15ffd', './combine-2f6226b9', './IndexDatatype-8e4fb082', './Math-03750a0b', './createTaskProcessorWorker', './Check-ed9ffed2', './when-f31b6bd1', './WebGLConstants-0664004c'], function (AttributeCompression, Cartesian2, combine, IndexDatatype, _Math, createTaskProcessorWorker, Check, when, WebGLConstants) { 'use strict';
