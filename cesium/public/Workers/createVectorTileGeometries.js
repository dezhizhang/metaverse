...
define(['./Transforms-baa7a7e7', './BoxGeometry-9ed2bec4', './Cartesian2-29c15ffd', './Color-deed0bb8', './CylinderGeometry-19cc3feb', './when-f31b6bd1', './EllipsoidGeometry-620e46f8', './IndexDatatype-8e4fb082', './createTaskProcessorWorker', './Check-ed9ffed2', './Math-03750a0b', './combine-2f6226b9', './RuntimeError-c7c236f3', './GeometryOffsetAttribute-f6456e72', './ComponentDatatype-6fe28ef7', './WebGLConstants-0664004c', './GeometryAttribute-1004876c', './GeometryAttributes-e973821e', './VertexFormat-44d61ac9', './CylinderGeometryLibrary-a5923d2f'], function (Transforms, BoxGeometry, Cartesian2, Color, CylinderGeometry, when, EllipsoidGeometry, IndexDatatype, createTaskProcessorWorker, Check, _Math, combine, RuntimeError, GeometryOffsetAttribute, ComponentDatatype, WebGLConstants, GeometryAttribute, GeometryAttributes, VertexFormat, CylinderGeometryLibrary) { 'use strict';
