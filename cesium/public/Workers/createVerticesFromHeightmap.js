...
define(['./Cartesian2-29c15ffd', './AxisAlignedBoundingBox-348290f1', './Transforms-baa7a7e7', './when-f31b6bd1', './Check-ed9ffed2', './TerrainEncoding-69fad7a7', './Math-03750a0b', './OrientedBoundingBox-e90d5605', './WebMercatorProjection-98814ec7', './RuntimeError-c7c236f3', './createTaskProcessorWorker', './combine-2f6226b9', './AttributeCompression-69f7b4c3', './ComponentDatatype-6fe28ef7', './WebGLConstants-0664004c', './EllipsoidTangentPlane-81e77c92', './IntersectionTests-d16f4d8c', './Plane-f1000363'], function (Cartesian2, AxisAlignedBoundingBox, Transforms, when, Check, TerrainEncoding, _Math, OrientedBoundingBox, WebMercatorProjection, RuntimeError, createTaskProcessorWorker, combine, AttributeCompression, ComponentDatatype, WebGLConstants, EllipsoidTangentPlane, IntersectionTests, Plane) { 'use strict';
  ...
  HeightmapTessellator.computeVertices = function (options) {
    ...
    var nativeRectangle = Cartesian2.Rectangle.clone(options.nativeRectangle);
    var rectangle = Cartesian2.Rectangle.clone(options.rectangle);
