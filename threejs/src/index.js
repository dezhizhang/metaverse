 ...
 * :last editor: 张德志
 * :date last edited: 2023-05-24 21:08:17
 */
...
function init() {
    ...
    function addLineShape(shape, color, x, y, z, rx, ry, rz, s) {
        ...
        line = new THREE.Line(geometrySpacedPoints,new THREE.LineBasicMaterial({
            color:color
        }));
        line.position.set(x,y,z + 25);
        ...
        // let particles = new THREE.Points(geometryPoints, new THREE.PointsMaterial({
        //     color: color,
        //     size: 4
        // }));
        ...
        // particles = new THREE.Points(geometrySpacedPoints, new THREE.PointsMaterial({
        //     color: color,
        //     size: 4
        // }));
